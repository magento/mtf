...
interface DateInterface
{
     ...
     *
     * @param  integer|string|array|\Mtf\Stdlib\DateTime\DateInterface $timestamp Timestamp to set
     * @return \Mtf\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Adds a timestamp
     *
     * @param  integer|string|array|\Mtf\Stdlib\DateTime\DateInterface $timestamp Timestamp to add
     * @return \Mtf\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  integer|string|array|\Mtf\Stdlib\DateTime\DateInterface $timestamp Timestamp to sub
     * @return \Mtf\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  integer|string|array|\Mtf\Stdlib\DateTime\DateInterface $timestamp Timestamp to compare
    ...
    /**
     * Returns only the time of the date as new \Mtf\Stdlib\DateTime\Date object
     * For example:
