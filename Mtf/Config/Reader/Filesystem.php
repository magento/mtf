 ...
 *
 */
namespace Mtf\Config\Reader;

/**
 * @SuppressWarnings(PHPMD.NumberOfChildren)
 */
class Filesystem implements \Mtf\Config\ReaderInterface
{
    /**
     * File locator
     *
     * @var \Mtf\Config\FileResolverInterface
     */
     ...
     * Config converter
     *
     * @var \Mtf\Config\ConverterInterface
     */
     ...
     * @param \Mtf\Config\ConverterInterface $converter
     * @param \Mtf\Config\SchemaLocatorInterface $schemaLocator
    ...
    public function __construct(
        ...
        \Mtf\Config\ConverterInterface $converter,
        \Mtf\Config\SchemaLocatorInterface $schemaLocator,
    ...
    {
        /** @var \Mtf\Config\Dom $configMerger */
        $configMerger = null;
        foreach ($fileList as $key => $content) {
            ...
            } catch (\Mtf\Config\Dom\ValidationException $e) {
    ...
    protected function _createConfigMerger($mergerClass, $initialContents)
    {
        ...
        if (!$result instanceof \Mtf\Config\Dom) {
