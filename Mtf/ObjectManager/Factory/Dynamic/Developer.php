 ...
 */
namespace Mtf\ObjectManager\Factory\Dynamic;

/**
 * Class Developer
 */
class Developer implements \Mtf\ObjectManager\FactoryInterface
{
    /**
     * Object manager
     *
     ...
     *
     * @var \Mtf\ObjectManager\ConfigInterface
     */
    protected $config;
     ...
     * Definition list
     *
     * @var \Mtf\ObjectManager\DefinitionInterface
     */
    ...
    public function __construct(
        ...
        $this->definitions = $definitions ?: new \Mtf\ObjectManager\Definition\Runtime();
     ...
     * @return void
     */
    public function setObjectManager(\Mtf\ObjectManagerInterface $objectManager)
    {
        $this->objectManager = $objectManager;
    }
