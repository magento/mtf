 ...
 */
namespace Mtf\ObjectManager\Definition;

/**
 * Class Runtime
 */
class Runtime implements \Mtf\ObjectManager\DefinitionInterface
{
    /**
     * @var array
     */
    ...
    /**
     * @param \Mtf\Code\Reader\ClassReader $reader
     */
    public function __construct(\Mtf\Code\Reader\ClassReader $reader = null)
    {
        $this->_reader = $reader ? : new \Mtf\Code\Reader\ClassReader();
    }
