...
use Mtf\ObjectManager\DefinitionInterface;
use Mtf\ObjectManager\RelationsInterface;

/**
 * Class Config
 */
class Config implements \Mtf\ObjectManager\ConfigInterface
{
    /**
     * Class definitions
     *
    ...
    {
        $this->_relations = $relations ? : new \Mtf\ObjectManager\Relations\Runtime();
        $this->_definitions = $definitions ? : new \Mtf\ObjectManager\Definition\Runtime();
    }
