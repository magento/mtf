...
class GenerateAbstract
{
    ...
    protected function _startFactory($type)
    {
        ...
        $this->_factoryContent .= "namespace Magento\Mtf\\{$type};\n\n";
        $this->_factoryContent .= "use Magento\Mtf\\System\\Config;\n\n";
    ...
    protected function _getPattern($type, $location)
    {
        ...
        if (isset($this->_params['generate_specified_modules'])
            ...
            $configModules = new \Magento\Mtf\System\Config($this->_params['specified_modules']);
