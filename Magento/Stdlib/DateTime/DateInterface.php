...
interface DateInterface
{
     ...
     *
     * @param  integer|string|array|\Magento\Stdlib\DateTime\DateInterface  $timestamp  Timestamp to set
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Adds a timestamp
     *
     * @param  integer|string|array|\Magento\Stdlib\DateTime\DateInterface  $timestamp  Timestamp to add
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  integer|string|array|\Magento\Stdlib\DateTime\DateInterface  $timestamp  Timestamp to sub
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  integer|string|array|\Magento\Stdlib\DateTime\DateInterface  $timestamp  Timestamp to compare
     ...
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $part  OPTIONAL Defines the date or datepart to return as integer
     ...
     * For a complete list of supported datepart values look into the docu
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date or datepart to set
     ...
     * For a complete list of supported datepart values look into the docu.
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date or datepart to add
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date or datepart to subtract
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date or datepart to compare with the date object
    ...
    /**
     * Returns a new instance of \Magento\Stdlib\DateTime\DateInterface with the selected part copied.
     ...
     * @return \Magento\Stdlib\DateTime\DateInterface New clone with requested part
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date or datepart to equal with
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date or datepart to compare with
     * @param  string                          $part    OPTIONAL Part of the date to compare, if null the timestamp is used
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return boolean
     * @throws \Zend_Date_Exception
    ...
    /**
     * Returns only the time of the date as new \Magento\Stdlib\DateTime\Date object
     * For example:
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $time    Time to set
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $time    Time to add
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     ...
     * For example: HH:mm:ss -> 10 -> -10 hours
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $time    Time to sub
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid inteface
     * @throws \Zend_Date_Exception
     */
     ...
     * For example: HH:mm:ss -> 10 -> 10 hours
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $time    Time to compare
     * @param  string                          $format  OPTIONAL Timeformat for parsing input
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date to set
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date to add
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date to sub
     * @param  string                          $format  OPTIONAL Date format for parsing input
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Date to compare
     * @param  string                          $format  OPTIONAL Date format for parsing input
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     ...
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $date    ISO Date to set
     * @param  string|\Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $date    ISO Date to add
     * @param  string|\Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $date    ISO Date to sub
     * @param  string|\Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $date    RFC 822 to set
     * @param  string|\Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $date    RFC 822 Date to add
     * @param  string|\Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|\Magento\Stdlib\DateTime\DateInterface  $date    RFC 822 Date to sub
     * @param  string|\Zend_Locale        $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  integer|array|\Magento\Stdlib\DateTime\DateInterface  $year  Year to check
     * @return boolean
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Year to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Year to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $date    Year to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $year    Year to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Month to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Month to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returned is the new date object
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Month to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Month to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Day to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * set locale.
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Day to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * set locale.
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Day to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $day     Day to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Weekday to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * wednesday.
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Weekday to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * wednesday.
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $month   Weekday to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $weekday  Weekday to compare
     * @param  string|\Zend_Locale              $locale   OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $day     Day of Year to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $day     Day of Year to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $day     Day of Year to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $day     Day of Year to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $hour    Hour to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $hour    Hour to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $hour    Hour to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $hour    Hour to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $minute  Minute to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $minute  Minute to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $minute  Minute to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $minute  Hour to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface $second Second to set
     * @param  string|\Zend_Locale             $locale (Optional) Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface $second Second to add
     * @param  string|\Zend_Locale             $locale (Optional) Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface $second Second to sub
     * @param  string|\Zend_Locale             $locale (Optional) Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     * Returns if equal, earlier or later
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface $second Second to compare
     * @param  string|\Zend_Locale             $locale (Optional) Locale for parsing input
     * @return integer  0 = equal, 1 = later, -1 = earlier
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  integer|\Magento\Stdlib\DateTime\DateInterface $milli     (Optional) Millisecond to set, when null the actual millisecond is set
     ...
     *
     * @param  integer|\Magento\Stdlib\DateTime\DateInterface $milli     (Optional) Millisecond to add, when null the actual millisecond is added
     ...
     *
     * @param  integer|\Magento\Stdlib\DateTime\DateInterface $milli     (Optional) Millisecond to sub, when null the actual millisecond is subtracted
     * @param  integer           $precision (Optional) Fractional precision for the given milliseconds
     * @return $this Provides fluid interface
     */
     ...
     *
     * @param  integer|\Magento\Stdlib\DateTime\DateInterface  $milli  OPTIONAL Millisecond to compare, when null the actual millisecond is compared
     * @param  integer            $precision  OPTIONAL Fractional precision for the given milliseconds
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $week    Week to set
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $week    Week to add
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface  Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $week    Week to sub
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return \Magento\Stdlib\DateTime\DateInterface Provides fluid interface
     * @throws \Zend_Date_Exception
     */
     ...
     *
     * @param  string|integer|array|\Magento\Stdlib\DateTime\DateInterface  $week    Week to compare
     * @param  string|\Zend_Locale              $locale  OPTIONAL Locale for parsing input
     * @return integer 0 = equal, 1 = later, -1 = earlier
     */
     ...
     *
     * @param  string|array|\Magento\Stdlib\DateTime\DateInterface $date   Date to parse for correctness
